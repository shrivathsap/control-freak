...
Save the thing as a .pyw file so that it doesn't open the console. Add it to the list of start-up programs on windose, i think windose has an option to keep the thing running for a specified time interval everyday...
